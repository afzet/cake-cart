...
class PaypalHelper extends AppHelper {
  ...
  function __construct(){
    ...
    $this->config['business'] => $this->Session->read('Settings.paypal.address');
    $this->config['notify_url'] => 'http://'. $this->Session->read('Settings.paypal.address') .'/paypal_ipn/process';
    parent::__construct();  
  }
