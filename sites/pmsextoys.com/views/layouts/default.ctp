...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
        <head>
                ...
                <meta name="description" content="<?php echo $session->read('Settings.description_pmsextoys');?>" />
                <meta name="keywords" content="<?php echo $session->read('Settings.keywords_pmsextoys');?>" />
                <meta name="robots" content="index, follow" />
                <meta name="robots" content="all" />
                <meta name="msvalidate.01" content="1F63A1CE80D05C2E4E103C323134EB01" />
                <meta name="google-site-verification" content="A0SFHFShmtQsmMND7BZa8MtMcih1X_A1Nu3JtiQSg3U" />
		...
		<table id="main" width="940" cellspacing="0" cellpadding="0" border="0" style="text-align: center">
			<tr>
				<td style="background: url(/img/web_logo.gif) no-repeat; height: 99px; text-align: right">
					<?php echo $html->link($html->image('banners/passion-parties.png'),'/parties' ,array('escape' => false),null,false)?>
				</td>				
			</tr>
			<tr>
				<td>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0">
						<tr>
							<td valign="top" style="width: 194px">
								<?php echo $this->element('nav_sidebar'); ?>
							</td>
			...
			<tr>
          	...
          	of the following: RSAC Cyber Patrol Safesurf SurfWatch Websense SmartAlex. 
  					...
  					?>
  					<br /><br />
  					<?php echo $session->read('Settings.copyright_pmsextoys');?>
  					<br /><br />
  					<?php echo $html->link('18 U.S.C Section 2257 Compliance Notice', '/docs/2257');?>
					</div>
    ...
    <div style="display:none">
		<script type="text/javascript">
			...
			<script type="text/javascript">
			try {
			var pageTracker = _gat._getTracker("UA-12414161-1");
