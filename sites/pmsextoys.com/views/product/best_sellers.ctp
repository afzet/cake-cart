		...
		<tr>
			<td>
				<div style="font-size: 16px; font-family: Arial; color: #F75696; font-weight: bold;">
					Best Sellers <a href="http://passionmansion.com/rss/recent.xml"><img src="/img/icons/rss.png" alt="RSS Feed" valign="middle" /></a>
				</div>				
			</td>
		</tr>
	</table>
...
<br />
<?
//	echo $this->element('product_view', array('data' => $data));
?>
Sorry we are currently restructuring our system. Please bare with us during this transition.