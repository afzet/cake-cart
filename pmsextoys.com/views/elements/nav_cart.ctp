...
<?php if (isset($cart) && count($cart['items'])>0) { ?>
<table width="100%" cellspacing="0" cellpadding="0">
<?php 
$i = 1;
...
?>
	<tr>
		<td><a href="/cart/delete/<?php echo $i?>" style="color:red" onclick="return confirm('Are you sure?');"><img src="/img/icons/bullet_delete.png" alt="Delete" valign="middle" align="left" /></a></td>
		<td><?php echo $dojo->productLink($item)?><?php echo $item['Product']['product_name']?></a></td>
	</tr>
<?php 
	$i++;
} 
