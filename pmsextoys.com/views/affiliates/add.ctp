...
Items marked with (<span style="color: #990000">*</span>) are required.
      ...
      <?php echo $form->input('Affiliate.email_confirm', array('class'=>'contact','label'=>'Notifcation Email', 'style' => 'width:250px')); ?>
      
      <p class="note">
      The address above is the email we will use to contact you.
      </p>      
      <?php echo $form->input('Affiliate.email', array('class'=>'contact','label'=>'Contact Email', 'style' => 'width:250px')); ?>
      
      <p class="note">
      Main URL for your Company (Leave blank if you don't have a website).
      </p>
      <?php echo $form->input('Affiliate.website', array('class'=>'contact','label'=>'Main URL', 'style' => 'width:250px')); ?>
