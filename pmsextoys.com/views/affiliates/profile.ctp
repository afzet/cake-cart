...
<div style="padding: 10px;">
  <table width="600" cellspacing="0" cellpadding="0" align="left">
    ...
    <tr>
    	...
    	<td class="profile"><?php echo $affiliate['aff_code']?></td>
    </tr>
    <tr>
    ...
    <tr>
    	...
    	<td class="profile">
    	  ...
    	  <?=ucwords($affiliate['city'])?>, <?=strtoupper($affiliate['state'])?> <?php echo $affiliate['zip']?><br />
    	  <?php echo $affiliate['country']?>
    	</td>
    </tr>
    <tr>
    ...
    <tr>
    	<td class="profile" style="text-align: center;"><?php echo $payment['Payment']['created']?></td>
    	<td class="profile" style="text-align: center;">$<?php echo $payment['Payment']['amount_paid']?></td>
    </tr>
    <? } ?>
    <? if(empty($payments)) { ?>
    <tr>
    ...
    <tr><th colspan="2" style="padding: 4px; text-align: left;">Your Tracking Link</th></tr>
      <td colspan="2" style="padding: 4px; text-align: left;">
        ...
        <a href="http://passionmansion.com/?a=<?php echo $affiliate['aff_code']?>e">http://passionmansion.com/?a=<?php echo $affiliate['aff_code']?></a><br />
      </td>
    </tr>
    <tr><td colspan="2">&nbsp;</td></tr>
