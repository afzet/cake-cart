...
class GoogleCheckoutComponent extends Object
{
	...
	{
		$this->_merchantID = $this->Session->read('Gateways.google.merchantID');
		$this->_merchantKey = $this->Session->read('Gateways.google.merchantKey');
		$this->_currency = $this->Session->read('Gateways.google.currency');

		$this->_restoreFromSessionArr();

		$this->_gserve = $this->Session->read('Gateways.google.mode');
